...
%                            SCENARIO TWO
%==========================================================================
% the scenario two using the following options:
...
%==========================================================================
% The difference betwen the scenario one and scenario two is the limit for 
...
file_nav  ='eph.dat';
file_obs  ='rcvr.dat';
file1     = 'satposfile_scen2.txt'; fid_file1 = fopen(file1,'w');
file2     = 'rcvposfile_scen2.txt'; fid_file2 = fopen(file2,'w');
file3     = 'satresfile_scen2.txt'; fid_file3 = fopen(file3,'w');
