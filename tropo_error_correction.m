...
%  Date  : 13-10-2021 
%  source: goGPS v0.4.3, 2009-2014 Mirko Reguzzoni, Eugenio Realini
%--------------------------------------------------------------------------
...
%
% input:        el       = satellite elevation
%               h        = receiver ellipsoidal height
%
% output:       corr     = tropospheric error correction
%
% description : calculate the troppsheric delay using the Saastamoinen algorithm. 
%--------------------------------------------------------------------------
